...
package body ADMBase.Text_IO is
   ...
   is
      ...
      begin
         ...
         num_vars := 10;  -- number of phyical data in each row
   ...
   begin
      ...
      Put (txt, spc (1) & str (gab (i,j,k)(xx)));
      Put (txt, spc (1) & str (gab (i,j,k)(yy)));
      Put (txt, spc (1) & str (gab (i,j,k)(zz)));
      Put (txt, spc (1) & str (Kab (i,j,k)(xx)));
      Put (txt, spc (1) & str (Kab (i,j,k)(yy)));
      Put (txt, spc (1) & str (Kab (i,j,k)(zz)));
   ...
   begin
      ...
      Put (spc(1) & str(gab (i,j,k)(xx),10));
      Put (spc(1) & str(gab (i,j,k)(zz),10));
      Put (spc(1) & str(Kab (i,j,k)(xx),10));
      Put (spc(1) & str(Kab (i,j,k)(zz),10));

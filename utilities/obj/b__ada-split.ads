...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_ada_split" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#ad3b478b#;
   pragma Export (C, u00001, "ada_splitB");
   ...
   u00005 : constant Version_32 := 16#ba821203#;
   ...
   u00059 : constant Version_32 := 16#e5331d7b#;
   pragma Export (C, u00059, "ada__calendar__formattingB");
   u00060 : constant Version_32 := 16#0dbf7387#;
   pragma Export (C, u00060, "ada__calendar__formattingS");
   u00061 : constant Version_32 := 16#e3cca715#;
   pragma Export (C, u00061, "ada__calendar__time_zonesB");
   u00062 : constant Version_32 := 16#07d0e97b#;
   pragma Export (C, u00062, "ada__calendar__time_zonesS");
   u00063 : constant Version_32 := 16#0f9783a4#;
   pragma Export (C, u00063, "system__val_intB");
   u00064 : constant Version_32 := 16#bda40698#;
   pragma Export (C, u00064, "system__val_intS");
   u00065 : constant Version_32 := 16#3cdd1378#;
   pragma Export (C, u00065, "system__unsigned_typesS");
   u00066 : constant Version_32 := 16#383fd226#;
   pragma Export (C, u00066, "system__val_unsB");
   u00067 : constant Version_32 := 16#09db6ec1#;
   pragma Export (C, u00067, "system__val_unsS");
   u00068 : constant Version_32 := 16#269742a9#;
   pragma Export (C, u00068, "system__val_utilB");
   u00069 : constant Version_32 := 16#a4fbd905#;
   pragma Export (C, u00069, "system__val_utilS");
   u00070 : constant Version_32 := 16#ec4d5631#;
   pragma Export (C, u00070, "system__case_utilB");
   u00071 : constant Version_32 := 16#378ed9af#;
   pragma Export (C, u00071, "system__case_utilS");
   u00072 : constant Version_32 := 16#c5134340#;
   pragma Export (C, u00072, "system__val_realB");
   u00073 : constant Version_32 := 16#0624832e#;
   pragma Export (C, u00073, "system__val_realS");
   u00074 : constant Version_32 := 16#b2a569d2#;
   pragma Export (C, u00074, "system__exn_llfB");
   u00075 : constant Version_32 := 16#b425d427#;
   pragma Export (C, u00075, "system__exn_llfS");
   u00076 : constant Version_32 := 16#0cccd408#;
   pragma Export (C, u00076, "system__fat_llfS");
   u00077 : constant Version_32 := 16#1b28662b#;
   pragma Export (C, u00077, "system__float_controlB");
   u00078 : constant Version_32 := 16#e8a72cc7#;
   pragma Export (C, u00078, "system__float_controlS");
   u00079 : constant Version_32 := 16#582b098c#;
   pragma Export (C, u00079, "system__powten_tableS");
   u00080 : constant Version_32 := 16#5b4659fa#;
   pragma Export (C, u00080, "ada__charactersS");
   u00081 : constant Version_32 := 16#8f637df8#;
   pragma Export (C, u00081, "ada__characters__handlingB");
   u00082 : constant Version_32 := 16#3b3f6154#;
   pragma Export (C, u00082, "ada__characters__handlingS");
   u00083 : constant Version_32 := 16#4b7bb96a#;
   pragma Export (C, u00083, "ada__characters__latin_1S");
   u00084 : constant Version_32 := 16#e6d4fa36#;
   pragma Export (C, u00084, "ada__stringsS");
   u00085 : constant Version_32 := 16#96df1a3f#;
   pragma Export (C, u00085, "ada__strings__mapsB");
   u00086 : constant Version_32 := 16#1e526bec#;
   pragma Export (C, u00086, "ada__strings__mapsS");
   u00087 : constant Version_32 := 16#98e13b0e#;
   pragma Export (C, u00087, "system__bit_opsB");
   u00088 : constant Version_32 := 16#0765e3a3#;
   pragma Export (C, u00088, "system__bit_opsS");
   u00089 : constant Version_32 := 16#92f05f13#;
   pragma Export (C, u00089, "ada__strings__maps__constantsS");
   u00090 : constant Version_32 := 16#ab4ad33a#;
   pragma Export (C, u00090, "ada__directories__validityB");
   u00091 : constant Version_32 := 16#498b13d5#;
   pragma Export (C, u00091, "ada__directories__validityS");
   u00092 : constant Version_32 := 16#bf363ed2#;
   pragma Export (C, u00092, "ada__strings__fixedB");
   u00093 : constant Version_32 := 16#fec1aafc#;
   pragma Export (C, u00093, "ada__strings__fixedS");
   u00094 : constant Version_32 := 16#2eb48a6d#;
   pragma Export (C, u00094, "ada__strings__searchB");
   u00095 : constant Version_32 := 16#c1ab8667#;
   ...
   u00101 : constant Version_32 := 16#8c99dc11#;
   pragma Export (C, u00101, "system__htableS");
   u00102 : constant Version_32 := 16#089f5cd0#;
   pragma Export (C, u00102, "system__string_hashB");
   u00103 : constant Version_32 := 16#2ec7b76f#;
   pragma Export (C, u00103, "system__string_hashS");
   u00104 : constant Version_32 := 16#b8e72903#;
   pragma Export (C, u00104, "system__val_lluB");
   u00105 : constant Version_32 := 16#51139e9a#;
   pragma Export (C, u00105, "system__val_lluS");
   u00106 : constant Version_32 := 16#acee74ad#;
   pragma Export (C, u00106, "system__compare_array_unsigned_8B");
   u00107 : constant Version_32 := 16#a1581e76#;
   ...
   u00109 : constant Version_32 := 16#1b57d1c8#;
   ...
   u00113 : constant Version_32 := 16#53a75631#;
   ...
   u00125 : constant Version_32 := 16#2bb6f156#;
   ...
   u00132 : constant Version_32 := 16#4e0ce0a1#;
   pragma Export (C, u00132, "system__crtlS");
   u00133 : constant Version_32 := 16#c3fe6846#;
   pragma Export (C, u00133, "system__file_attributesS");
   u00134 : constant Version_32 := 16#b870d14d#;
   ...
   u00139 : constant Version_32 := 16#e4774a28#;
   pragma Export (C, u00139, "system__os_libB");
   u00140 : constant Version_32 := 16#d8e681fb#;
   pragma Export (C, u00140, "system__os_libS");
   u00141 : constant Version_32 := 16#2a8e89ad#;
   pragma Export (C, u00141, "system__stringsB");
   u00142 : constant Version_32 := 16#684d436e#;
   pragma Export (C, u00142, "system__stringsS");
   u00143 : constant Version_32 := 16#f5c4f553#;
   pragma Export (C, u00143, "system__file_control_blockS");
   u00144 : constant Version_32 := 16#95f86c43#;
   pragma Export (C, u00144, "system__regexpB");
   u00145 : constant Version_32 := 16#2b69c837#;
   pragma Export (C, u00145, "system__regexpS");
   u00146 : constant Version_32 := 16#f4e097a7#;
   pragma Export (C, u00146, "ada__text_ioB");
   u00147 : constant Version_32 := 16#3913d0d6#;
   pragma Export (C, u00147, "ada__text_ioS");
   u00148 : constant Version_32 := 16#4d89d64a#;
   pragma Export (C, u00148, "supportB");
   u00149 : constant Version_32 := 16#c1643455#;
   pragma Export (C, u00149, "supportS");
   u00150 : constant Version_32 := 16#b5988c27#;
   pragma Export (C, u00150, "gnatS");
   u00151 : constant Version_32 := 16#ef2c0748#;
   pragma Export (C, u00151, "gnat__os_libS");
   u00152 : constant Version_32 := 16#1291404b#;
   pragma Export (C, u00152, "support__cmdlineB");
   u00153 : constant Version_32 := 16#b90a7d55#;
   pragma Export (C, u00153, "support__cmdlineS");
   u00154 : constant Version_32 := 16#01a73f89#;
   pragma Export (C, u00154, "ada__command_lineB");
   u00155 : constant Version_32 := 16#3cdef8c9#;
   pragma Export (C, u00155, "ada__command_lineS");
   u00156 : constant Version_32 := 16#0809f29b#;
   pragma Export (C, u00156, "support__regexB");
   u00157 : constant Version_32 := 16#8d70645e#;
   pragma Export (C, u00157, "support__regexS");
   u00158 : constant Version_32 := 16#8f9f9fb7#;
   pragma Export (C, u00158, "gnat__regpatS");
   u00159 : constant Version_32 := 16#863444e5#;
   pragma Export (C, u00159, "system__regpatB");
   u00160 : constant Version_32 := 16#8a01f484#;
   pragma Export (C, u00160, "system__regpatS");
   u00161 : constant Version_32 := 16#2b93a046#;
   pragma Export (C, u00161, "system__img_charB");
   u00162 : constant Version_32 := 16#946f371c#;
   pragma Export (C, u00162, "system__img_charS");
   u00163 : constant Version_32 := 16#1fcea9da#;
   pragma Export (C, u00163, "support__stringsB");
   u00164 : constant Version_32 := 16#2860f389#;
   pragma Export (C, u00164, "support__stringsS");
   u00165 : constant Version_32 := 16#25afee5b#;
   pragma Export (C, u00165, "ada__text_io__float_auxB");
   u00166 : constant Version_32 := 16#6ecdea4c#;
   pragma Export (C, u00166, "ada__text_io__float_auxS");
   u00167 : constant Version_32 := 16#181dc502#;
   pragma Export (C, u00167, "ada__text_io__generic_auxB");
   u00168 : constant Version_32 := 16#305a076a#;
   pragma Export (C, u00168, "ada__text_io__generic_auxS");
   u00169 : constant Version_32 := 16#8aa4f090#;
   pragma Export (C, u00169, "system__img_realB");
   u00170 : constant Version_32 := 16#cff33e19#;
   pragma Export (C, u00170, "system__img_realS");
   u00171 : constant Version_32 := 16#3e932977#;
   pragma Export (C, u00171, "system__img_lluB");
   u00172 : constant Version_32 := 16#751413bb#;
   pragma Export (C, u00172, "system__img_lluS");
   u00173 : constant Version_32 := 16#ec78c2bf#;
   pragma Export (C, u00173, "system__img_unsB");
   u00174 : constant Version_32 := 16#a3292f8f#;
   pragma Export (C, u00174, "system__img_unsS");
   u00175 : constant Version_32 := 16#fdedfd10#;
   pragma Export (C, u00175, "ada__text_io__integer_auxB");
   u00176 : constant Version_32 := 16#2fe01d89#;
   pragma Export (C, u00176, "ada__text_io__integer_auxS");
   u00177 : constant Version_32 := 16#b10ba0c7#;
   pragma Export (C, u00177, "system__img_biuB");
   u00178 : constant Version_32 := 16#faff9b35#;
   pragma Export (C, u00178, "system__img_biuS");
   u00179 : constant Version_32 := 16#4e06ab0c#;
   pragma Export (C, u00179, "system__img_llbB");
   u00180 : constant Version_32 := 16#bb388bcb#;
   pragma Export (C, u00180, "system__img_llbS");
   u00181 : constant Version_32 := 16#9dca6636#;
   pragma Export (C, u00181, "system__img_lliB");
   u00182 : constant Version_32 := 16#19143a2a#;
   pragma Export (C, u00182, "system__img_lliS");
   u00183 : constant Version_32 := 16#a756d097#;
   pragma Export (C, u00183, "system__img_llwB");
   u00184 : constant Version_32 := 16#1254a85d#;
   pragma Export (C, u00184, "system__img_llwS");
   u00185 : constant Version_32 := 16#eb55dfbb#;
   pragma Export (C, u00185, "system__img_wiuB");
   u00186 : constant Version_32 := 16#94be1ca7#;
   pragma Export (C, u00186, "system__img_wiuS");
   u00187 : constant Version_32 := 16#fb020d94#;
   pragma Export (C, u00187, "system__val_lliB");
   u00188 : constant Version_32 := 16#6435fd0b#;
   pragma Export (C, u00188, "system__val_lliS");
